...
![flippie schematics](https://github.com/545ch4/flippie/board/schematics.png | width=200 "flippie schematics")

### Layout

![flippie board top view](https://github.com/545ch4/flippie/board/board_top.png | width=100 "flippie board top view")
![flippie board bottom view](https://github.com/545ch4/flippie/board/board_bottom.png | width=100 "flippie board bottom view")
